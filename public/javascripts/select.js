...
var buildPath = function(){
    ...
    if(reportType == "IndicatorReport"){
        ...
        path = window.location.protocol + "//" + window.location.host + "/datavis/copd/IndicatorReport/" + outArr[0] + "/" + outArr[1] + "/" + outArr[2]  + "/" + outArr[3];
    ...
    if(reportType == "OverviewReport"){
        ...
        path = window.location.protocol + "//" + window.location.host + "/datavis/copd/OverviewReport/" + outArr[0] + "/" + outArr[1] + "/" + outArr[2];
    }
    ...
    if(reportType == "AreaReport"){
        ...
        path = window.location.protocol + "//" + window.location.host + "/datavis/copd/AreaReport/" + outArr[0] + "/" + outArr[1] + "/" + outArr[2];
    }
